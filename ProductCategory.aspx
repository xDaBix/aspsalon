<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductCategory.aspx.cs" Inherits="SalonProject.admin.ProductCategory" %>
...
<body>
    <form id="form1" runat="server">
        <div class="form-container">
            <h2>Add Product Category</h2><br /><br />
           
            <div class="form-group">
                <label for="txtCategoryName">Enter Product Category:</label>
            ...
            <div class="form-group">
                <label for="ddlCategoryType">Select Product Type:</label>
           ...
           <asp:Button ID="add" class="btnadd" Text="Add" runat="server" OnClick="ProductClick" />
           <div>
