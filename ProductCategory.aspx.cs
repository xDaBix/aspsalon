...
namespace SalonProject.admin
{
    public partial class ProductCategory : System.Web.UI.Page
    {
        ...
        protected void ProductClick(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(txtCategoryName.Text.Trim()))
            {
                ...
                {
                    con.Open();
                    string qry = "SELECT * FROM ProductCategory WHERE LOWER(CategoryName) = @name and CType=@type";
            ...
            if (value == true)
            {
                ...
                string query = "INSERT INTO ProductCategory (CategoryName, CType) VALUES (@CategoryName, @CategoryType)";
